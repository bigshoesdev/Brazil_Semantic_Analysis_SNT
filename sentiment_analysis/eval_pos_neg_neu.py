...
from sentiment_analysis.data_helpers import load_data_and_labels
...
if __name__ == '__main__':
    ...
    tf.flags.DEFINE_string("neutral_data_file", config.project_path + "sentiment_analysis/data/test/test.neu",
    ...
    tf.flags.DEFINE_string("checkpoint_dir",
                           config.project_path + "sentiment_analysis/runs/" + config.sentiment_checkpoint,
